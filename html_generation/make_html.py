...
def write_head(f):
    f.write('<head>\n')
    f.write('<meta name="viewport" content="width=device-width, initial-scale=2.0">\n')
    f.write('<style> body {background-color: rgb(50,50,50); color: white; font-size: 2.20vmax;} </style>\n')
